...
<blockquote><b>Move your static object members from the plugin's namespace into external classes/singletons and then, reference them from a plugin that uses a class factory to build objects.</b></blockquote>
